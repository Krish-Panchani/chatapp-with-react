      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg text-center">
          ...
          <p className="mt-4 text-gray-500">
            Optimized WebChat platform The SendBox BETA v.0.1 is here. Private,
            Secure & Faster Chat plateform.
          </p>
        </div>
        ...
        <form
          ...
          autoComplete="off"
          className="form login mx-auto mt-8 mb-0 max-w-md space-y-4"
        >
          <div>
